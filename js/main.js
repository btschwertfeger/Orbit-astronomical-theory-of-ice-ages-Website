...
function plot_contour_1(input = {
    ...
    const days_per_month = calendar(orbital_parameter.ecc, orbital_parameter.long_perh);
    let tickvals = [...new Array(13)].map(() => 0);
    for (let i = 0; i < 12; i++) tickvals[i + 1] = tickvals[i] + days_per_month[i];
